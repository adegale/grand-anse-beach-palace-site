    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden pt-32">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 animate-fade-in leading-tight">
          ...
          <span className="block text-[#FFD166] mt-3 text-3xl md:text-4xl lg:text-5xl font-light italic">because it's time…</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
          <button
            ...
            className="bg-[#F56416] text-white px-10 py-4 rounded-full text-lg font-semibold hover:bg-[#29BF12] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            Book Your Stay
          </button>
          <button
        ...
        <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-md px-6 py-3 rounded-full">
          <span className="text-[#FFD166] font-semibold text-sm md:text-base">Direct Booking Perks:</span>
