import { MapPin, Phone, Mail, Facebook, Instagram, Heart, Linkedin, MessageCircle } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a href="#" className="bg-[#2B59C3] p-3 rounded-full hover:bg-[#29BF12] transition-colors" aria-label="Facebook">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="#" className="bg-[#F56416] p-3 rounded-full hover:bg-[#29BF12] transition-colors" aria-label="Instagram">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="#" className="bg-[#25D366] p-3 rounded-full hover:bg-[#29BF12] transition-colors" aria-label="WhatsApp">
                <MessageCircle className="w-5 h-5" />
              </a>
              <a href="#" className="bg-[#0077B5] p-3 rounded-full hover:bg-[#29BF12] transition-colors" aria-label="LinkedIn">
