const attractions = [
  {
    ...
    image: '/media/attractions/grand-anse-beach.jpg',
  ...
  },
  {
    ...
    image: '/media/attractions/st-georges-grenada.jpg',
  ...
  },
  {
    ...
    image: '/media/attractions/belmont-estate.jpg',
  ...
  },
  {
    ...
    image: '/media/attractions/seven-sisters.jpg',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Explore <span className="text-[#F56416]">Grenada</span>
          </h2>
