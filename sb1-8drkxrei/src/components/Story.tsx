        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700 text-lg leading-relaxed mb-8">
              ...
              <p className="font-semibold text-blaze-orange text-xl">
                At Grand Beach Palace Hotel, the Caribbean isn't a backdrop — it's the rhythm of the entire experience.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-laser-blue/10 to-laser-blue/5 p-5 rounded-xl">
              ...
              <div className="bg-gradient-to-br from-bright-fern/10 to-bright-fern/5 p-5 rounded-xl">
                <MapPin className="w-8 h-8 text-text-blaze-orange mb-3" />
                <h4 className="font-bold text-gray-900 mb-1">Prime Location</h4>
                <p className="text-sm text-gray-600">Steps from Grand Anse</p>
              </div>
              <div className="bg-gradient-to-br from-golden-pollen/10 to-golden-pollen/5 p-5 rounded-xl">
                <Users className="w-8 h-8 text-blaze-orange mb-3" />
                <h4 className="font-bold text-gray-900 mb-1">Spacious Rooms</h4>
                <p className="text-sm text-gray-600">Room to truly relax</p>
              </div>
              <div className="bg-gradient-to-br from-blaze-orange/10 to-blaze-orange/5 p-5 rounded-xl">
                <Palmtree className="w-8 h-8 text-blaze-orange mb-3" />
